...
- If a student asks how to use BridgeAI, tell them: "Click [Get Started](/onboard) to upload your transcript or fill out a quick form — we'll match you to every program you qualify for in 15 seconds."
...
export function LandingBridgeBot() {
  ...
  const send = useCallback(async (text: string) => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/chat/landing-bot`, {
        method: "POST",
  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        type="button"
        aria-label={open ? "Close BridgeBot" : "Open BridgeBot"}
        aria-expanded={open}
        onClick={() => setOpen(o => !o)}
        style={{
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            role="dialog"
            aria-label="BridgeBot CUNY resource advisor"
          ...
          >
            ...
            <div style={{
              ...
              <input
                ...
                aria-label="Ask BridgeBot a question"
