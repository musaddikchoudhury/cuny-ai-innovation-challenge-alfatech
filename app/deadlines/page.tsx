...
export default function DeadlinesPage() {
  ...
  const scheduleReminder = async (res: Resource) => {
    ...
    try {
      await fetch(`${API_BASE_URL}/schedule-gmail-reminder`, {
        method: "POST",
      ...
      <div className="max-w-4xl mx-auto px-6" style={{ paddingTop: 88 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 10, flexShrink: 0 }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      ...
                      <button
                        ...
                        aria-label={isReminded ? `Reminder set for ${res.name}` : `Set reminder for ${res.name}`}
                      ...
                      {res.deadline && (
                        <a
                          ...
                          aria-label={`Add ${res.name} deadline to Google Calendar`}
                          style={{
                            width: 36, height: 36,
        ...
        {filtered.length === 0 && (
          <div style={{ textAlign: "center", padding: "60px 20px" }}>
            ...
            <button type="button" onClick={() => setFilter("all")} className="btn-outline" style={{ marginTop: 16, display: "inline-flex" }}>
